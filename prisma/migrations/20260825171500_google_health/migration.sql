-- Create Google Health persistence tables that are present in schema.prisma.
-- Production uses `prisma migrate deploy`, so a migration is required for
-- these models to exist in the deployed database.
